...
## Context
Choosing the backend stack for *felicia* requires balancing standard, stable library ecosystems with performance and build portability. Furthermore, the database choice needs to align with modern standards for spatial geometry and JSON manipulation.
